...
public class VentanaEmpleadosActualizar extends javax.swing.JFrame {
    ...
    public VentanaEmpleadosActualizar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(280, 0, 300, 50);
        ...
        btnActualizar.setBounds(510, 240, 90, 30);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        Empleados empleado = new Empleados(Integer.parseInt(tf_idempleado.getText()), tf_nombre.getText(),tf_direccion.getText(),
        tf_telefono.getText(),Double.valueOf(tf_salario.getText()),tf_ocupacion.getText());

        if (tf_nombre.getText().equals("") || tf_direccion.getText().equals("") || 
            tf_telefono.getText().equals("") || tf_salario.getText().equals("") || tf_ocupacion.getText().equals("")) {
            JOptionPane.showMessageDialog(getContentPane(), "Faltan datos");
        }else {
            if (eDAO.actualizarEmpleado(empleado)) {
                JOptionPane.showMessageDialog(getContentPane(), "Actualizado con éxito");
                metodoRestablecer(tf_direccion, tf_idempleado, tf_nombre, 
                tf_ocupacion, tf_salario, tf_telefono);

                actualizarTablas(tabla1);
            } else {
                JOptionPane.showMessageDialog(getContentPane(), "No se actualizó");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaEmpleadosActualizar().setVisible(true);
            }
        });
    }
